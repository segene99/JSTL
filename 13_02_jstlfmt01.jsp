...
<body>
	...
	<small style="color:red">예시: message_ko.properties, message_en.propoerties</small><br>
	</li>
	</ol>
	...
	&lt;fmt:message key="properties파일안의 변수이름" var="메세지를 저장하는 변수이름"
	scope="4개영역" /&gt;<br>
	</pre>
		<fmt:bundle basename="com.member">
			<p><fmt:message key="idKey" />: <fmt:message key="id" /></p>
			<p><fmt:message key="passwordKey" />: <fmt:message key="passwordKey" /></p>

...
<%
request.setAttribute("person", "파이리");
pageContext.setAttribute("person", "꼬북이");
%>
<!DOCTYPE html>
<html>
<head>
<title>기본객체를 사용한 EL</title>
</head>
<body>
	<h2>기본객체를 사용한 EL</h2>
	...
	request에 설정한 person 속성: ${requestScope.person}<br>
	page에 설정한 person 속성:${pageScope.person}<br>
	<hr>
<%-- 	request에 설정한 person 속성: ${person}<br><hr>  --%>
